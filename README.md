...
_(Make sure you replace the URL with the actual GitHub link to this repository)_ 4. Go to **File > Open Folder...** and select the newly created `Discord_fish` folder.
